...
def create_parser():
    ...
    parser.add_argument("--dms-input", type=pathlib.Path, default="./data/protein_dms.csv", help="CSV file containing the deep mutational scan")
...
def main(args):
    ...
    if args.dms_output is None:
        args.dms_output = pathlib.Path(f"./outputs/protein-dms_{args.scoring_strategy}.csv")
...
# Example usage:
# python3 ./scripts/protein_mutation_scoring.py --model "facebook/esm2_t12_35M_UR50D" --sequence "MKTIIALSYIFCLVFA" --dms-input ./data/protein_dms.csv --dms-output ./outputs/masked-marginal.csv --mutation-col mutant --scoring-strategy masked-marginals
