...
# Example usage:
# python dna_mutation_pairs_fasta.py --interval [1-100] --fasta_file "Homo_sapiens_BRAF_sequence.fa" --mutation_effects_output "dna_mutation_effects.csv" --pair_effects_output "dna_pair_effects.csv"
